...
```{r}
#Use future map to calculate tree densities
tree_density = future_map_dfr(nyc_shp$GEOID, aggregate_trees, tracts_shp = nyc_shp, id_var = "GEOID", trees_shp = trees_shp, .progress = TRUE)
```
